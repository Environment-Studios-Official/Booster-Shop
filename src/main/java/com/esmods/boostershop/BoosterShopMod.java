package com.esmods.boostershop;
...
@Mod("booster_shop")
public class BoosterShopMod {
	public static final Logger LOGGER = LogManager.getLogger(BoosterShopMod.class);
	public static final String MODID = "booster_shop";

	public BoosterShopMod(IEventBus modEventBus) {
